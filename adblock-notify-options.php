...
function an_create_options() {
	...
	\anbb\AdmiralAdBlockAnalytics::registerSettings('adblock-notify-settings-group');
	...
	$admiralPanel = $an_panel->createAdminPanel( array(
	'name' => 'Admiral Settings',
	'id' => AN_ID . '-admiral',
	'use_form' => false,
	) );
	...
	$admiralPanel->createOption(
		array(
		'custom' => '
		<h3>Admiral Settings</h3>

		    <p style="font-size: 14px; margin-bottom: 10px; max-width: 750px;">Ad Blocker Notify is now integrated with Admiral Adblock Suite. Admiral provides the most advanced adblock analytics platform in the industry and offers premium products like <a href="https://getadmiral.com/products/engage">Engage</a> and <a href="https://getadmiral.com/products/transact">Transact</a> that empower you to recover more revenue than ever before. <a href="https://getadmiral.com/">Learn More</a></p>' . \anbb\AdmiralAdBlockAnalytics::getCTA() . '
		<form method="post" action="options.php" class="admiral-settings-form">
			<input type=\'hidden\' name=\'option_page\' value="' . esc_attr('adblock-notify-settings-group') . '" />
	        <input type="hidden" name="action" value="update" />
	        ' . wp_nonce_field($aciton = "adblock-notify-settings-group-options", "_wpnonce", true, false) . '
		    ' . \anbb\AdmiralAdBlockAnalytics::getPropertyIDInput() . '
		    <input style="margin-top: 10px;" type="submit" name="submit" id="submit" class="button button-primary" value="Save Changes">
		</form>',
		'type' => 'custom',
		'paragraph' => false,
		)
	...
	$alternativeTab->createOption(
		...
		'default' => '
                        ...
                        <p>' . __( 'Please add', 'an-translate' ) . ' <a title="https://getadmiral.com?utm_medium=plugin&utm_campaign=abn&utm_source=abnlinks" href="https://getadmiral.com?utm_medium=plugin&utm_campaign=abn&utm_source=abnlinks" target="_blank">www.getadmiral.com</a> ' . __( 'to your adblocking whitelist or disable your adblocking software.', 'an-translate' ) . '</p>
			',
		)
	);
	$alternativeTab->createOption(
